...
void qspInitStats()
{
  ...
  qspAddStatName(qspStatFreeLib, QSP_STATIC_STR(QSP_FMT("KILLQST")), 2);
  qspAddStatName(qspStatFreeLib, QSP_STATIC_STR(QSP_FMT("DELLIB")), 2);
	...
	qspAddStatName(qspStatIncLib, QSP_STATIC_STR(QSP_FMT("ADDQST")), 2);
  qspAddStatName(qspStatIncLib, QSP_STATIC_STR(QSP_FMT("ADDLIBP")), 2);
